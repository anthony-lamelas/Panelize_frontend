...
const Index = () => {
  ...
  const handleSubmit = async (description: string, panelCount: number) => {
    setIsLoading(true);
    ...
    try {
      ...
      setTimeout(() => {
        ...
        const mockPanels: Panel[] = Array.from({ length: panelCount }, (_, i) => ({
          ...
          description: `Panel ${i+1}: ${description.substring(0, 25)}${description.length > 25 ? '...' : ''}`
        }));
        ...
        toast({
          ...
          description: `Successfully created ${panelCount} panels for your story.`,
        });
      }, 2000);
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-panelize-soft-gray">
      <div className="container px-4 py-8 mx-auto max-w-6xl">
        <header className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-panelize-dark-purple to-panelize-purple bg-clip-text text-transparent mb-4">
            Panelize
          </h1>
        ...
        {!panels.length && !isLoading && (
          <div className="mt-16 text-center text-gray-500">
            <div className="w-24 h-24 mx-auto mb-6 bg-panelize-light-purple rounded-full flex items-center justify-center">
              <svg className="w-12 h-12 text-panelize-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
